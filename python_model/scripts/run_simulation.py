...
def main():
    ...
    fxp_ordered_fft_output_float = np.array(
        [complex(from_fxp(x.real) * N_POINTS, from_fxp(x.imag) * N_POINTS) for x in fxp_ordered_fft_output], dtype=np.complex64)
